...
public class Ritmamida : MonoBehaviour
{
    ...
    void CreateLine(float duration, Color lineColor)
    {
        ...
        target.transform.position += new Vector3(0, yOffset / 2.5f);
...
//        GameObject newLine = CreateLine(duration, lineColor); // Создаем линию с учетом времени

//        // Обновляем цель для камеры на новую линию
//        if (cameraFollow != null)
//        {
//            cameraFollow.target = newLine.transform;
//        }
//    }

//    GameObject CreateLine(float duration, Color lineColor)
//    {
//        // Проверка на null, чтобы избежать ошибок
//        if (linePrefab == null || lineContainer == null)
//        {
...
//        return newLine; // Возвращаем созданную линию, чтобы камера могла следить за ней
//    }
